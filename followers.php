...
<body>
    ...
    <!-- Start of home page -->
    <div data-role="page" id="profilepage" class="page page-following page-followers">
        ...
        <div data-role="peoples" class="peoples">
            <div class="friend">
                <a href="http://" class="man-wrap">
                    <div class="avatar">
                        <div class="photo-wrap">
                            <img src="./svg/following/avatar-1.svg" alt="" srcset="">
                        </div>
                    </div>
                    <div class="text">
                        <div class="title">
            ...
            <div class="friend">
                <a href="http://" class="man-wrap">
                    <div class="avatar">
                        <div class="photo-wrap">
                            <img src="./svg/following/avatar-3.svg" alt="" srcset="">
                        </div>
                    </div>
                    <div class="text">
                        <div class="title">
